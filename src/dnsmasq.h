...
#define MAX_WILDCARD_LENGTH 150
#define MAX_WILDCARD_ENTRY 128
...
extern struct daemon {
    ...
    char *servers_file;
    char *wildcard_file;
    char *https_wildcard_file;
    char *wildcard_204file;
    char *wildcard_cnafile;
    char wildcard_domain[MAX_WILDCARD_ENTRY][MAX_WILDCARD_LENGTH];
    char https_wildcard_domain[MAX_WILDCARD_ENTRY][MAX_WILDCARD_LENGTH];
    char wildcard_204domain[MAX_WILDCARD_ENTRY][MAX_WILDCARD_LENGTH];
    char wildcard_cnadomain[MAX_WILDCARD_ENTRY][MAX_WILDCARD_LENGTH];
    unsigned int numwc;
    unsigned int https_numwc;
    unsigned int numwc204;
    unsigned int numwccna;
